...
public class CategoriesController {
	...
	public ModelAndView passToUpdateForm(@PathVariable String categoryId) {
		 ...
		 //fill the update form with current parameters of the category to update
	...
	public ModelAndView updateCategory(@Valid @ModelAttribute("categoryFormModelToUpdate") CategoryFormModel categoryFormModel,
			BindingResult bindingResult) {
