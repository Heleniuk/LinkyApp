...
public class CategoryServiceImpl implements CategoryService {
	...
	public void add(CategoryFormModel categoryFormModel) {
		...
		if (isUnique(categoryFormModel.getTitle())) {
			...
			Category category = new Category(categoryFormModel.getTitle(), categoryFormModel.getDescription());
	...
	public void update(CategoryFormModel categoryFormModel) {
		...
		// if parent id is not null, we must ensure that it's not tied to itself
		// as a parent
		if (parentId != null) {
			if (parentId == id) {
